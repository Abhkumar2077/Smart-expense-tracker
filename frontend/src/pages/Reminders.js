...
import { FaBell, FaPlus, FaTrash, FaCheckCircle, FaClock, FaExclamationTriangle } from 'react-icons/fa';
...
const Reminders = () => {
  ...
  useEffect(() => {
    fetchReminders();
    fetchCategories();
  }, [fetchReminders, fetchCategories]);
  ...
  const handleEdit = (reminder) => {
    ...
    setFormData({
      ...
      due_date: reminder.due_date.split('T')[0], // Fix: Format date for input
